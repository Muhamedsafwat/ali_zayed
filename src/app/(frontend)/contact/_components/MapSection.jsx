...
const MapSection = () => {
  return (
    <section className="max-w-6xl mx-auto rounded-t-3xl flex p-4 md:flex-row flex-col gap-12 items-center justify-between text-white">
      <div className="flex-1">
        <div className="flex items-center gap-2">
          <div className="bg-blue-600 aspect-square w-3 rounded-full" />
          <p className="tracking-widest">Our space</p>
        </div>
        <h2 className="mt-8  text-3xl md:text-5xl tracking-wider leading-[1.1]">
      ...
      <div className="flex-1 w-full h-[25rem] rounded-xl overflow-hidden border-2 border-blue-700 ">
        <iframe
