(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/node_modules_@payloadcms_ui_dist_exports_shared_index_b86516.js", {

"[project]/node_modules/@payloadcms/ui/dist/exports/shared/index.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$payload$2f$dist$2f$config$2f$types$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/node_modules/payload/dist/config/types.js [app-client] (ecmascript)");
...
var w = ({ elements: e, translationString: t })=>{
    let r = /(<[^>]+>.*?<\/[^>]+>)/g, n = t.split(r);
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__.createElement("span", null, n.map((o, i)=>{
        if (e && o.startsWith("<") && o.endsWith(">")) {
            let s = o[1], a = e[s];
            if (a) {
                let c = new RegExp(`<${s}>(.*?)</${s}>`, "g"), m = o.replace(c, (l, u)=>u);
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__.createElement(a, {
                    key: i
    ...
    let o = r(t, n || {});
    return e ? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__.createElement(w, {
        elements: e,
        translationString: o
    }) : o;
};
...
function q({ Component: e, sanitizeServerOnlyProps: t, toMergeIntoProps: r }) {
    return t === void 0 && (t = !(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$payload$2f$dist$2f$utilities$2f$isReactComponent$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isReactServerComponentOrFunction"])(e)), (o)=>{
        let i = j(o, r);
        return t && __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$payload$2f$dist$2f$config$2f$types$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["serverProps"].forEach((s)=>{
            delete i[s];
...
var K = ({ Component: e, serverOnlyProps: t, ...r })=>e ? ((o)=>{
        let i = {
            ...o,
            ...(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$payload$2f$dist$2f$utilities$2f$isReactComponent$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isReactServerComponentOrFunction"])(e) ? t ?? {} : {}
        };
...
`, ee = ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].createElement("svg", {
        ...
        width: "193.38",
        xmlns: "http://www.w3.org/2000/svg"
    }, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].createElement("style", null, _), __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].createElement("g", {
        id: "c"
    }, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].createElement("path", {
...
var ne = {
    ...
    get: (e, t = {
        ...
        let r = "";
        return t.params && (r = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$qs$2d$esm$2f$lib$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__.stringify(t.params, {
            addQueryPrefix: !0
        })), fetch(`${e}${r}`, {
            credentials: "include",
            ...t
...
var S = ({ date: e, i18n: t, pattern: r, timezone: n })=>{
    ...
    if (n) {
        let i = f.tz(n), s = o.withTimeZone(n), a = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$transpose$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["transpose"])(s, i);
        return t.dateFNS ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(a, r, {
            locale: t.dateFNS
        }) : `${t.t("general:loading")}...`;
    }
    return t.dateFNS ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(o, r, {
        locale: t.dateFNS
    }) : `${t.t("general:loading")}...`;
};
;
var pe = ({ collectionConfig: e, data: t, dateFormat: r, fallback: n, globalConfig: o, i18n: i })=>{
    ...
    return o && (s = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$payloadcms$2f$translations$2f$dist$2f$utilities$2f$getTranslation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getTranslation"])(o?.label, i) || o?.slug), s || (s = n || `[${i.t("general:untitled")}]`), s;
};
;
    ...
    return e.reduce((o, i)=>{
        ...
        if (t?.[i.type.toLowerCase()]?.[i.entity.slug]?.read) {
            ...
            if (i.entity.admin.group) {
                let m = o.find((u)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$payloadcms$2f$translations$2f$dist$2f$utilities$2f$getTranslation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getTranslation"])(u.label, r) === s), l = m;
                m || (l = {
                    entities: [],
                    label: s
            ...
            } else o.find((l)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$payloadcms$2f$translations$2f$dist$2f$utilities$2f$getTranslation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getTranslation"])(l.label, r) === r.t(`general:${i.type}`)).entities.push({
                slug: i.entity.slug,
                type: i.type,
                label: c
            });
...
//# sourceMappingURL=node_modules_%40payloadcms_ui_dist_exports_shared_index_b86516.js.map